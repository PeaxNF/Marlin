...
#define e__steps 138.70 //e-steps is defined by the number of revolutions your extruder motor has to turn to define 10mm of filament.
#endif
...
/*if have a Custom ABL mount and need to put your own values, please use change_value to define your values below. If not, skip this section and continue below*/
  ...
  #define NOZZLE_TO_PROBE_OFFSET { -39.00, 6.00, 0 } //Measure the distance between the centre of your probe to the nozzle and replace 'change_value'. KEEP the value 0 there so you can do your z probe offset calibration. Only replace 0 if you know your values. Otherwise your nozzle may CRASH.
#endif
...
#define STRING_CONFIG_H_AUTHOR "PEAXNF" // Who made the changes.
